...
outputFolder = [workingFolder 'preprocFiles_behaviorAndSpikeInitialProcessed\\'] ; % where to save files
...
for f = 1:nfiles
    ...
    [trialData,taskInfo] = pp_spikeAlignmentToTrial(taskAlignedSpiketimes,synchInfo,trialData,taskInfo);
